import {readAssets,guardAssetTransition} from './assets-postgres.js';
...
export class PostgresStore {
 ...
 async transitionInTransaction(c,jobId,expectedVersion,to,meta={}){
   ...
   await guardAssetTransition(c,j,to,meta);
